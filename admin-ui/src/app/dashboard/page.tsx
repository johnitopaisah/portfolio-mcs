...
const CARDS = [
  { label: 'Projects',       key: 'projects'       as keyof PortfolioStats, href: '/dashboard/projects',       from: '#7c3aed', to: '#7C3AED', shadow: 'rgba(79,70,229,0.25)',    Icon: IconFolder,   desc: () => 'Portfolio items' },
  { label: 'Skills',         key: 'skills'         as keyof PortfolioStats, href: '/dashboard/skills',         from: '#0ea5e9', to: '#A855F7', shadow: 'rgba(14,165,233,0.2)',    Icon: IconZap,      desc: () => 'Technical stack' },
  { label: 'Experience',     key: 'experiences'    as keyof PortfolioStats, href: '/dashboard/experience',     from: '#f59e0b', to: '#ef4444', shadow: 'rgba(245,158,11,0.2)',    Icon: IconBriefcase,desc: () => 'Work history' },
  { label: 'Certifications', key: 'certifications' as keyof PortfolioStats, href: '/dashboard/certifications', from: '#10b981', to: '#0d9488', shadow: 'rgba(16,185,129,0.2)',    Icon: IconAward,    desc: () => 'Credentials' },
  { label: 'Messages',       key: 'unread'         as keyof PortfolioStats, href: '/dashboard/messages',       from: '#f43f5e', to: '#ec4899', shadow: 'rgba(244,63,94,0.2)',     Icon: IconMessage,  desc: (s: PortfolioStats) => s.unread > 0 ? `${s.unread} unread` : 'All read', badge: (s: PortfolioStats) => s.unread > 0 },
  { label: 'Profile',        key: null,                                      href: '/dashboard/profile',        from: '#a855f7', to: '#d946ef', shadow: 'rgba(168,85,247,0.2)',   Icon: IconUser,     desc: () => 'Edit your profile' },
  { label: 'AI Engine',      key: 'aiTotal'        as keyof PortfolioStats, href: '/dashboard/ai',             from: '#06b6d4', to: '#3b82f6', shadow: 'rgba(6,182,212,0.2)',     Icon: IconCpu,      desc: (s: PortfolioStats) => `${s.aiKept} kept · ${s.aiReview} review` },
  { label: 'Job Pipeline',   key: 'jobsNew'        as keyof PortfolioStats, href: '/dashboard/jobs',           from: '#22c55e', to: '#10b981', shadow: 'rgba(34,197,94,0.2)',     Icon: IconLayers,   desc: (s: PortfolioStats) => `${s.jobsSaved} saved · ${s.jobsApplied} applied` },
];
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        >
          ...
          <Link href="/dashboard/goals" className="text-xs font-medium" style={{ color: hc?.ring || '#fbbf24' }}>
            {hs?.label || 'Loading…'}
          </Link>
        </div>
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <Link href="/dashboard/applications" className="text-xs" style={{ color: '#A855F7' }}>View all →</Link>
          </div>
