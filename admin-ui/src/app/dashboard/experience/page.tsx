...
export default function ExperiencePage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      // Only send end_date if not ongoing
  ...
  return (
    <div>
            ...
            <div>
              ...
              >
                ...
                <input
                  ...
                  onBlur={addTag}
                  placeholder={techTags.length === 0 ? 'e.g. Kubernetes, AWS, Python…' : ''}
      ...
      <div className="space-y-3">
        ...
        {!items.length && (
          <p className="text-gray-500 text-sm text-center py-12">No experience entries yet.</p>
        )}
      </div>
    </div>
  );
